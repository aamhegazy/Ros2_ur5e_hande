...
def launch_setup(context, *args, **kwargs):
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare(description_package), "rviz", "view_ur5e.rviz"]
    )
    ...
    gripper_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["gripper_position_controller", "-c", "/controller_manager", "--stopped"],
        output="screen",
    )
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="ur5e_hande_description",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="ur5e_hande_controllers.yaml",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [
                    FindPackageShare("ur5e_hande_description"),
                    "config",
