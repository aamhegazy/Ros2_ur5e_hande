...
def generate_launch_description():
    ...
    # NOTE: xacro mappings must be plain strings or LaunchConfiguration objects.
    # PathJoinSubstitution does NOT work here — use the eagerly resolved strings above.
    moveit_config = (
        ...
        .robot_description(
            ...
            mappings={
                ...
                # IPs — LaunchConfiguration is fine here (resolved by xacro arg substitution)
                "robot_ip":         ur_ip,
                ...
                # UR script files — MUST be plain resolved strings, not substitutions
                "script_filename":        script_filename,
                "output_recipe_filename": output_recipe_filename,
                "input_recipe_filename":  input_recipe_filename,

                # Initial positions for fake hardware
                "initial_positions_file": initial_positions_file,

                # Gripper socat settings
    ...
    control_node = Node(
        ...
        parameters=[
            ...
            # These node-level params override/supplement what's in the URDF
            {"reverse_ip":         reverse_ip},
    ...
    # --- LAUNCH ORDER ---
    # RSP and control node start immediately.
    # Controllers + MoveGroup + RViz start only after joint_state_broadcaster is up.
